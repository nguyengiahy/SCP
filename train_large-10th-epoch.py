...
if __name__ == "__main__":
        ...
        #Add specific path for resume training
        ckpt_save_dir = Path.cwd().joinpath("checkpoint/checkpoint_" + "2024-03-19_09-23-32")
        tensorboard_save_dir = Path.cwd().joinpath("tensorboard/tensorboard_" + "2024-03-19_09-23-32")
        resume_ckpt = "checkpoint/checkpoint_2024-03-19_09-23-32/epoch_9.tar"
        ...
        if resume_ckpt is not None:
            # Load the checkpoint
            start_epoch, loss_dict, model, optimizer = load_ckpt(resume_ckpt)
